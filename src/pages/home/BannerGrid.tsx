  ...
  return (
    <section className="min-h-[600px] flex flex-col sm:flex-row gap-6  px-8 sm:px-40 ">
      <div className=" w-full sm:w-1/2 relative">
        ...
        <Tag tag="Couch" price="500" posB="top-6" country="France" />

      </div>

      {/*  */}
      <div className="w-full sm:w-1/2 flex flex-col gap-6 ">
        <GridItem img={pt2} tag="Drawer" country="Germany" price="250"/>
        <GridItem img={pt3} tag="Toaster" country="Italy" price="300"/>
      </div>
    </section>
  );
};
