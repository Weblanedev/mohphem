        ...
        <div className="flex flex-col gap-[15px] items-start w-full justify-center">
          ...
          <form>
            ...
            <button
              ...
              className={`group gap-[8px] mt-[30px] w-[100%] text-center text-[16px] sm:text-[24px] rounded-lg font-body bg-white text-blue ${!isButtonDisabled && 'hover:bg-blue hover:text-white'} px-[30px] sm:px-[97px] py-[15px] sm:py-[21px] border border-blue-500 transition-one`}>
              Place Order
            </button>
          </form>
        </div>
